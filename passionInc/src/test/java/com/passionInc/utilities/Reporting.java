...
public class Reporting extends TestListenerAdapter
{
	...
	public void onStart(ITestContext testContext)
	{
		...
		htmlReporter.config().setDocumentTitle("passionInc Automation Report"); // Tile of report
		htmlReporter.config().setReportName("PassionInc  Functional Testing"); // name of the report
